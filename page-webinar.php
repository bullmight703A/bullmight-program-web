            ...
            <?php while (have_posts()):
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div class="lg:col-span-5 space-y-8">
                        ...
                        <!-- Calendar Widget -->
                        <div class="bg-[#2563eb] p-6 rounded-[2rem] shadow-2xl shadow-blue-500/30 border border-blue-400 relative overflow-hidden">
                            <h3 class="text-xl font-extrabold text-white mb-6 px-2">Book an Individual Session</h3>
